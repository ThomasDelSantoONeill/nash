...
knitr::opts_knit$set(root.dir = "/home/tom/Documents/nash/vignettes/")
```
...
nash.eq.LV.BS <- readRDS("BS-NE-Fmsy-LV.rds")
BSCCdataY2 <- readRDS("CCYield_Spp_2.rds")
BSCCdataY3 <- readRDS("CCYield_Spp_3.rds")
BSCCdataY4 <- readRDS("CCYield_Spp_4.rds")
nash.eq.LV.BS.CC <- readRDS("BS-CCNE-Fmsy.rds")
# Plotting -----------------------------------------------------------------
library(ggplot2)
library(extrafont)
library(reshape2)
